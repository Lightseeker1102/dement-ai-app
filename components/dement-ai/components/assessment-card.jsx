...
const configs = {
    ...
    'stroop-test': {
        ...
        description: 'Identify text ink colors as fast as possible (Attention & Speed)',
        duration: '10 rounds',
        iconBg: '#fefcbf',
        iconColor: '#b7791f',
        icon: (_jsx("svg", { className: "w-6 h-6", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M13 10V3L4 14h7v7l9-11h-7z" }) })),
    },
    'digit-span': {
        title: 'Digit Memory Matrix',
        description: 'Memorize sequences and enter digits in REVERSE order (Working Memory)',
        duration: '5 rounds',
        iconBg: '#e6fffa',
        iconColor: '#234e52',
        icon: (_jsx("svg", { className: "w-6 h-6", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" }) })),
    },
};
